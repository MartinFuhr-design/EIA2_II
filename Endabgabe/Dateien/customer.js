...
var Endabgabe2;
(function (Endabgabe2) {
    class Costumer extends Endabgabe2.Moveable {
        constructor(_mood, _moodColor, _food, _extraWishes, _position, _time) {
        ...
        draw() {
            ...
            Endabgabe2.crc2.arc(this.position.x, this.position.y, this.radius, 0, 2 * Math.PI);
